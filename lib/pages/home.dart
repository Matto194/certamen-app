...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 54, 18, 87), // Cambia el color de la AppBar a uno de tu paleta de colores
      ),
      body: _tabs[_currentIndex],
      bottomNavigationBar: BottomNavigationBar(
        backgroundColor: Color(0xFF1F0A32), // Cambia el fondo del BottomNavigationBar a uno de tu paleta de colores
        selectedItemColor: Color(0xFF7B10A1), // Color para el ítem seleccionado
        unselectedItemColor: Color(0xFF4A7DDF), // Color para los ítems no seleccionados
