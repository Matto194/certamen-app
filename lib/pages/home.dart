...
class _HomeState extends State<Home> {
  int _currentIndex = 0;
  List<Widget> _tabs = [
    TabContract(),TabService(),TabHotel()
  ];
  @override
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(icon: Icon(MdiIcons.briefcase),label: 'Contratos'),
            BottomNavigationBarItem(icon: Icon(MdiIcons.vacuum),label: 'Servicios'),
            BottomNavigationBarItem(icon: Icon(MdiIcons.roomService),label: 'Hoteles'),
            ],
